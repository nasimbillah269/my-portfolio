...
const Navber = () => {
    const menuItem = <React.Fragment>
        ...
        <li><Link to="/aboute">Aboute me</Link></li>
    ...
    return (
        <div className="navbar bg-black text-white  font-bold flex justify-evenly">
            <div className="navbar-start">
                ...
                <Link><img className='w-20  h-26' src={logo} alt="" /></Link>
            </div>
