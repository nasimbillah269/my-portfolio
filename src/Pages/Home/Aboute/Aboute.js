            ...
            <div className="hero">
                <div className="hero-content flex-col lg:flex-row-reverse p-12">
                    <div className="lg:w-1/2 lg:ml-20">
                        <h1 className='text-white lg:text-3xl text-2xl font-semibold mb-3'>Hi, I'm MD Nasim Billah</h1>
                        ...
                        <div className='flex mt-8'>
                            <a href="https://www.linkedin.com/in/nasim-billah-456a5321b/" target="_blank" rel="noopener noreferrer">
                                <FaLinkedin className='text-4xl text-white mr-4 animate-bounce hover:bg-blue-600 hover:border-0  '></FaLinkedin>
                            </a>
